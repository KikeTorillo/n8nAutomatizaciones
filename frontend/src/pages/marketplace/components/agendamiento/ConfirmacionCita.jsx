 ...
 */
function ConfirmacionCita({ datosAgendamiento, perfil, onAnterior, onExito }) {
      ...
      <div className="text-center py-12">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 max-w-md mx-auto">
          <p className="text-sm text-gray-700 dark:text-gray-300">
            El negocio se pondrá en contacto contigo pronto para confirmar la
            disponibilidad.
          </p>
        </div>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-primary-50 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 rounded-lg p-4">
        <p className="text-sm text-primary-800 dark:text-primary-300">
          <strong>Importante:</strong> Recibirás un correo de confirmación. El
          negocio puede contactarte para confirmar la disponibilidad.
        </p>
      </div>
