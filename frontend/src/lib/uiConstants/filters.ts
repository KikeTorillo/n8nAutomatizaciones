 ...
 */
export const FILTER_PANEL_CONTAINER =
  'bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm';

/**
 * Estilos del header del panel de filtros
 */
export const FILTER_PANEL_HEADER =
...
export const FILTER_COUNT_BADGE =
  'inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 text-xs font-bold rounded-full bg-primary-600 text-white';
...
export const FILTER_CHECKBOX_STYLES = {
  container:
    'flex items-center gap-2.5 py-1.5 px-2 rounded-md cursor-pointer transition-colors hover:bg-gray-100 dark:hover:bg-gray-700',
  containerDisabled: 'opacity-50 cursor-not-allowed',
  input:
    'h-4 w-4 rounded border-gray-300 dark:border-gray-600 text-primary-600 focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400 dark:bg-gray-700',
...
export const FILTER_SELECT_STYLES = {
  ...
  select:
    'w-full px-3 py-2 text-sm rounded-lg border bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:border-primary-500 dark:focus-visible:ring-primary-400 dark:focus-visible:border-primary-400',
} as const;

/**
 * Estilos del título de sección de filtros
 */
export const FILTER_SECTION_TITLE =
  'flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400';
