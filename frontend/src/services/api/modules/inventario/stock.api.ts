...
export const stockApi = {
   ...
   */
  ajustarStock: (id: number, data: Record<string, unknown>): Promise<AxiosResponse> =>
    apiClient.patch(`/inventario/productos/${id}/stock`, data),
   ...
   * @returns {Promise<Object>}
   */
  registrarMovimiento: (data: Record<string, unknown>): Promise<AxiosResponse> =>
   ...
   */
  listarMovimientos: (params: Record<string, unknown> = {}): Promise<AxiosResponse> =>
   ...
   */
  obtenerKardex: (productoId: number, params: Record<string, unknown> = {}): Promise<AxiosResponse> =>
    apiClient.get(`/inventario/movimientos/kardex/${productoId}`, { params }),
   ...
   */
  obtenerEstadisticasMovimientos: (params: Record<string, unknown>): Promise<AxiosResponse> =>
    apiClient.get('/inventario/movimientos/estadisticas', { params }),
   ...
   */
  obtenerStockDisponible: (productoId: number, params: Record<string, unknown> = {}): Promise<AxiosResponse> =>
   ...
   */
  obtenerStockDisponibleMultiple: (data: Record<string, unknown>): Promise<AxiosResponse> =>
   ...
   */
  verificarDisponibilidad: (productoId: number, params: Record<string, unknown>): Promise<AxiosResponse> =>
   ...
   */
  obtenerStockPorUbicacion: (productoId: number, params: Record<string, unknown> = {}): Promise<AxiosResponse> =>
   ...
   */
  obtenerMiStock: (productoId: number): Promise<AxiosResponse> =>
   ...
   */
  listarProductosStockFiltrado: (params: Record<string, unknown> = {}): Promise<AxiosResponse> =>
