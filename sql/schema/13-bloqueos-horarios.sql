-- ⚠️  MIGRADO A bloqueos/01-06
-- ESTE ARCHIVO HA SIDO COMPLETAMENTE MIGRADO AL MÓDULO BLOQUEOS
-- Ver: sql/bloqueos/01-tabla-bloqueos.sql
--      sql/bloqueos/02-indices.sql
--      sql/bloqueos/03-rls-policies.sql
--      sql/bloqueos/04-funciones.sql
--      sql/bloqueos/05-triggers.sql
--      sql/bloqueos/06-vistas.sql
-- Migración: 17 Noviembre 2025
-- --
-- 
-- -- ====================================================================
