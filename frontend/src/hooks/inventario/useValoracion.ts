 ...
 */
export function useReporteValoracionCategorias(params: Record<string, unknown> = {}) {
    return useQuery({
 ...
 */
export function useReporteDiferenciasValoracion(params: Record<string, unknown> = {}) {
    return useQuery({
 ...
 */
export function useValoracionFIFO(productoId: number | undefined | null, params: Record<string, unknown> = {}) {
    return useQuery({
 ...
 */
export function useValoracionAVCO(productoId: number | undefined | null, params: Record<string, unknown> = {}) {
    return useQuery({
 ...
 */
export function formatearValor(valor: number | null | undefined, decimales: number = 2) {
