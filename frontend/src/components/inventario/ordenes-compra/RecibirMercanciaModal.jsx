    ...
    >
      {isLoading ? (
        ...
        <div className="p-8 text-center text-gray-500">
          ...
          <p className="text-lg font-medium">Todos los productos han sido recibidos</p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div>
                <p className="text-sm font-medium text-blue-800">Registro de Recepción</p>
                  ...
                  <tr key={item.item_id}>
                    ...
                    <td className="px-4 py-3">
                      <input
                        ...
                        className="w-24 text-center rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
              ...
              <div className="space-y-3">
                {recepciones
                  ...
                  .map((item, idx) => {
                    ...
                    return (
                      <div key={item.item_id} className="bg-white rounded-lg p-3 border">
          ...
          <div className="flex items-center justify-between pt-4 border-t">
            <div className="text-sm text-gray-600">
              Total a recibir: <span className="font-bold text-indigo-600">{totalARecibir}</span> unidades
            </div>
