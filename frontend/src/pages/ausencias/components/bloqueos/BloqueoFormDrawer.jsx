...
function BloqueoFormDrawer({
  ...
  return (
    <Drawer
      ...
      subtitle={
        modo === 'crear'
          ? 'Configura el período de bloqueo'
          : 'Modifica el bloqueo existente'
      }
    >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-amber-700 dark:text-amber-300 mb-3">
                    El módulo de Vacaciones gestiona saldos, aprobaciones y
                    genera el bloqueo automáticamente.
                  </p>
                  <Button
                    type="button"
                    variant="outline"
          ...
          {esOrganizacional ? (
            <div className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg p-3">
              <p className="text-sm text-primary-800 dark:text-primary-200">
                Este tipo de bloqueo se aplicará a{' '}
                <strong>toda la organización</strong> y afectará a todos los
                profesionales.
              </p>
            </div>
          ) : (
        ...
        <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          {diasBloqueo > 0 && (
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <strong>Duración:</strong> {diasBloqueo}{' '}
                {diasBloqueo === 1 ? 'día' : 'días'}
              </p>
            </div>
          )}
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">
              Deja estos campos vacíos para bloquear días completos. Especifica
              horas solo si deseas bloquear un horario parcial.
            </p>
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-amber-800 dark:text-amber-200">
                ...
                <p>
                  Este bloqueo actualmente afecta{' '}
                  <strong>{bloqueo.citas_afectadas} citas</strong>. Modificar
                  las fechas puede tener impacto en estas reservas.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <label className="text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <span className="text-gray-500 dark:text-gray-400 ml-1">
                      (Desactívalo si ya no aplica pero deseas mantener el
                      registro)
                    </span>
                  </label>
                </div>
