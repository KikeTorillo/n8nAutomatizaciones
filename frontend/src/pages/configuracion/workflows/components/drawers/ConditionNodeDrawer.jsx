...
import { GitBranch, Save, X, HelpCircle } from 'lucide-react';
        ...
        <div className="flex items-start gap-3 p-3 bg-primary-50 dark:bg-primary-900/20 rounded-lg">
          ...
          <div className="text-sm text-primary-700 dark:text-primary-300">
            ...
            <ul className="text-xs mt-1 space-y-0.5">
              <li>
                <span className="font-mono bg-green-200 dark:bg-green-800 px-1 rounded">
                  Sí
                </span>
        ...
        {tieneCondiciones && (
          <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            ...
            <code className="text-sm text-gray-700 dark:text-gray-300 break-all">
              {formData.condicion.condiciones
                .map((c, i) => {
                  const parts = [];
                  ...
                  const connector =
                    i < formData.condicion.condiciones.length - 1
