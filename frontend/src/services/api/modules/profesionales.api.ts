...
export const profesionalesApi = {
  /** Crear profesional */
  crear: (data: Record<string, any>) => apiClient.post('/profesionales', data),

  /** Crear múltiples profesionales en transacción (bulk) */
  crearBulk: (profesionales: Record<string, any>[]) => apiClient.post('/profesionales/bulk-create', {
    profesionales
  }),

  /** Listar profesionales con filtros */
  listar: (params: Record<string, any> = {}) => apiClient.get('/profesionales', { params }),

  /** Obtener profesional por ID */
  obtener: (id: number) => apiClient.get(`/profesionales/${id}`),

  /** Actualizar profesional */
  actualizar: (id: number, data: Record<string, any>) => apiClient.put(`/profesionales/${id}`, data),
  ...
  listarPorModulo: (modulo: string, params: Record<string, any> = {}) => apiClient.get(`/profesionales/por-modulo/${modulo}`, { params }),
  ...
  listarDocumentos: (profesionalId: number, params: Record<string, any> = {}) =>
  ...
  actualizarDocumento: (profesionalId: number, documentoId: number, data: Record<string, any>) =>
  ...
  verificarDocumento: (profesionalId: number, documentoId: number, data: Record<string, any>) =>
  ...
  obtenerUrlDocumento: (profesionalId: number, documentoId: number, params: Record<string, any> = {}) =>
  ...
  listarCuentasBancarias: (profesionalId: number, params: Record<string, any> = {}) =>
    apiClient.get(`/profesionales/${profesionalId}/cuentas-bancarias`, { params }),

  /** Crear cuenta bancaria */
  crearCuentaBancaria: (profesionalId: number, data: Record<string, any>) =>
  ...
  actualizarCuentaBancaria: (profesionalId: number, cuentaId: number, data: Record<string, any>) =>
  ...
  listarExperiencia: (profesionalId: number, params: Record<string, any> = {}) =>
    apiClient.get(`/profesionales/${profesionalId}/experiencia`, { params }),

  /** Crear experiencia laboral */
  crearExperiencia: (profesionalId: number, data: Record<string, any>) =>
  ...
  actualizarExperiencia: (profesionalId: number, experienciaId: number, data: Record<string, any>) =>
  ...
  reordenarExperiencia: (profesionalId: number, data: Record<string, any>) =>
  ...
  listarEducacion: (profesionalId: number, params: Record<string, any> = {}) =>
    apiClient.get(`/profesionales/${profesionalId}/educacion`, { params }),

  /** Crear registro de educación formal */
  crearEducacion: (profesionalId: number, data: Record<string, any>) =>
  ...
  actualizarEducacion: (profesionalId: number, educacionId: number, data: Record<string, any>) =>
  ...
  reordenarEducacion: (profesionalId: number, data: Record<string, any>) =>
  ...
  listarHabilidades: (profesionalId: number, params: Record<string, any> = {}) =>
    apiClient.get(`/profesionales/${profesionalId}/habilidades`, { params }),

  /** Asignar habilidad a profesional */
  asignarHabilidad: (profesionalId: number, data: Record<string, any>) =>
    apiClient.post(`/profesionales/${profesionalId}/habilidades`, data),

  /** Asignar múltiples habilidades en batch */
  asignarHabilidadesBatch: (profesionalId: number, data: Record<string, any>) =>
  ...
  actualizarHabilidadEmpleado: (profesionalId: number, habilidadEmpleadoId: number, data: Record<string, any>) =>
  ...
  verificarHabilidadEmpleado: (profesionalId: number, habilidadEmpleadoId: number, data: Record<string, any>) =>
  ...
  obtenerProgresoOnboarding: (profesionalId: number, params: Record<string, any> = {}) =>
    apiClient.get(`/profesionales/${profesionalId}/onboarding/progreso`, { params }),

  /** Marcar tarea de onboarding como completada/pendiente */
  marcarTareaOnboarding: (profesionalId: number, tareaId: number, data: Record<string, any>) =>
