...
const VARIANTE_CLASSES = {
  ...
  secundario:
    'bg-gray-100 hover:bg-gray-200 text-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-100 border-transparent',
  outline:
    'bg-transparent hover:bg-primary-50 text-primary-600 border-primary-600 dark:hover:bg-primary-950',
  ghost:
    'bg-transparent hover:bg-gray-100 text-gray-700 dark:hover:bg-gray-800 dark:text-gray-300 border-transparent',
...
function BotonElementRenderer({ elemento, tema, onClick, disabled = false }) {
