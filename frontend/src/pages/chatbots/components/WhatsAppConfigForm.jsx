...
const whatsappSchema = z.object({
  ...
  api_key: z
    ...
    .regex(
      /^[A-Za-z0-9_-]+$/,
      'El Access Token solo puede contener letras, números, guiones y guiones bajos'
    ),
  phone_number_id: z
    .string()
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-green-800 dark:text-green-200">
            <p className="font-semibold mb-1">
              ¿No tienes una cuenta de WhatsApp Business?
            </p>
            <p className="mb-2">
              Necesitas crear una cuenta de WhatsApp Business Cloud API en Meta
              for Developers.
            </p>
            <button
              type="button"
      ...
      {showInstructions && (
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 space-y-3">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700 dark:text-gray-300">
            ...
            <li>
              Copia el <strong>Phone Number ID</strong> (ID del número de
              teléfono)
            </li>
            <li>
            ...
            <li>
              Opcionalmente, copia el <strong>Business Account ID</strong> desde
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded p-3 mt-3">
            <p className="text-xs text-yellow-800 dark:text-yellow-200">
              <strong>Importante:</strong> El Access Token es sensible. Guárdalo
              de forma segura y nunca lo compartas públicamente.
            </p>
          </div>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {isLoading && (
          <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <LoadingSpinner
              size="sm"
              text="Validando credenciales con Meta y configurando workflow..."
            />
          </div>
        )}
        ...
        {isSuccess && (
          <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-green-800 dark:text-green-200">
                <p className="font-semibold mb-1">
                  ¡Bot de WhatsApp configurado exitosamente!
                </p>
