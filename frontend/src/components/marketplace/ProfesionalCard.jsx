  ...
  return (
    ...
    >
      <div className="flex items-start space-x-4">
        {/* Avatar placeholder */}
        <div className="flex-shrink-0 w-16 h-16 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Biografía */}
          {biografia && (
            <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-3">{biografia}</p>
          )}
        </div>
      </div>
    </div>
