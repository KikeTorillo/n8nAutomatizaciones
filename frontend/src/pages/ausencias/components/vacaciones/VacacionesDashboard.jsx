        ...
        {getModalData('detalle') && (
          <div className="space-y-6">
              ...
              <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                ...
                {getModalData('detalle').es_medio_dia && (
                  <p className="text-xs text-gray-500 mt-1">
                    Turno:{' '}
                    {getModalData('detalle').turno_medio_dia === 'manana'
                      ? 'Mañana'
                      : 'Tarde'}
                  </p>
                )}
            ...
            {(getModalData('detalle').estado === 'aprobada' ||
              getModalData('detalle').estado === 'rechazada') && (
              <div
            ...
            <div className="flex items-center justify-between text-xs text-gray-400 pt-4 border-t border-gray-200 dark:border-gray-700">
              <span>
                Creado: {formatFecha(getModalData('detalle').creado_en)}
              </span>
              {getModalData('detalle').actualizado_en !==
                getModalData('detalle').creado_en && (
                <span>
                  Actualizado:{' '}
                  {formatFecha(getModalData('detalle').actualizado_en)}
                </span>
              )}
            </div>
