...
import { Users, Network, ClipboardList, ChevronDown, Check } from 'lucide-react';
...
function getActiveItem(pathname) {
  ...
  // Default a lista si estamos en /profesionales/*
...
/**
 * Selector móvil - Un único dropdown con todos los items
 */
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-900 dark:text-gray-100">
            {activeItem?.label || 'Profesionales'}
          </span>
        </div>
