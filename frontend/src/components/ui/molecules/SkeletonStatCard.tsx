    ...
    if (variant === 'expanded') {
      return (
        <div
          ...
          aria-busy="true"
          className={cn(
            'bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 animate-pulse',
            className
          )}
        >
          ...
          <div
            className={cn('h-8 rounded w-16 mb-2', LOADING_STATES.skeleton)}
          />
    ...
    return (
      ...
      >
        <div className="flex items-center gap-2 sm:gap-3">
          <div
            className={cn('w-10 h-10 rounded-lg', LOADING_STATES.skeleton)}
          />
          <div className="flex-1">
            <div
              className={cn('h-3 rounded w-16 mb-2', LOADING_STATES.skeleton)}
            />
