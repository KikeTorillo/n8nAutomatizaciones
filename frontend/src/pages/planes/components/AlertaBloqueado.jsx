...
const ESTADOS_CONFIG = {
  suspendida: {
    ...
    message:
      'Tu suscripción ha sido suspendida. Por favor, selecciona un plan para reactivar tu cuenta.',
    variant: 'error',
  },
  cancelada: {
    icon: XCircle,
    ...
    message:
      'Tu suscripción ha sido cancelada. Selecciona un plan para volver a usar el sistema.',
    variant: 'error',
  },
  vencida: {
    icon: Clock,
    ...
    message:
      'Tu período de suscripción ha terminado. Renueva tu plan para continuar usando el sistema.',
    variant: 'warning',
  },
  trial_expirado: {
    icon: Clock,
    ...
    message:
      'Tu período de prueba ha finalizado. Selecciona un plan para continuar disfrutando de todas las funciones.',
    variant: 'warning',
  },
  grace_period_expirado: {
    ...
    message:
      'El período de gracia ha expirado. Por favor, actualiza tu método de pago o selecciona un plan.',
    variant: 'error',
  },
  pendiente_pago: {
    icon: AlertTriangle,
    ...
    message:
      'Tienes un pago pendiente. Completa el pago para continuar usando el sistema.',
    variant: 'warning',
  },
  sin_suscripcion: {
    icon: AlertTriangle,
...
function AlertaBloqueado({ estado, className }) {
  ...
  return (
    <div
      className={cn('border rounded-lg p-4 mb-6', styles.container, className)}
    >
