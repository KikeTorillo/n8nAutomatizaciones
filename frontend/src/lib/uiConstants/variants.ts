...
export const BUTTON_VARIANTS: Record<ButtonVariant, string> = {
  primary: 'bg-primary-700 text-white hover:bg-primary-800 focus-visible:ring-primary-500 dark:bg-primary-600 dark:hover:bg-primary-500',
  ...
  outline: 'border-2 border-primary-300 text-primary-700 hover:bg-primary-50 focus-visible:ring-primary-500 dark:border-primary-600 dark:text-primary-300 dark:hover:bg-primary-950',
  ...
  warning: 'bg-amber-600 text-white hover:bg-amber-700 focus-visible:ring-amber-500 dark:bg-amber-700 dark:hover:bg-amber-600',
  success: 'bg-green-600 text-white hover:bg-green-700 focus-visible:ring-green-500 dark:bg-green-700 dark:hover:bg-green-600',
