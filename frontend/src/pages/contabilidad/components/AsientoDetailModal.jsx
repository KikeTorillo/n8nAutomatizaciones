      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-gray-100">
                {format(
                  new Date(asientoDetalle?.fecha || asiento.fecha),
                  'dd/MM/yyyy'
                )}
              </p>
            </div>
          ...
          <div>
            ...
            <p className="font-medium text-gray-900 dark:text-gray-100">
              {asientoDetalle?.concepto || asiento.concepto}
            </p>
          </div>
                ...
                <tfoot className="bg-gray-50 dark:bg-gray-900">
                  <tr>
                    ...
                    <td className="px-3 py-2 text-right font-bold text-gray-900 dark:text-gray-100">
                      {formatCurrency(
                        asientoDetalle?.total_debe || asiento.total_debe || 0
                      )}
                    </td>
                    <td className="px-3 py-2 text-right font-bold text-gray-900 dark:text-gray-100">
                      {formatCurrency(
                        asientoDetalle?.total_haber || asiento.total_haber || 0
                      )}
                    </td>
                  </tr>
                </tfoot>
