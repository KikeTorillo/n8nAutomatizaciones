...
function ContabilidadPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value:
        typeof dashboard?.asientos_mes === 'object'
          ? (dashboard?.asientos_mes?.publicados || 0) +
            (dashboard?.asientos_mes?.borradores || 0)
    ...
    },
    {
      ...
      description: dashboard?.configurado
        ? 'Listo para usar'
    ...
    >
          ...
          {stats.map((stat) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className={`text-2xl font-bold ${stat.isText ? 'text-lg' : ''} text-gray-900 dark:text-gray-100`}
                >
                  {stat.value}
                </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-yellow-700 dark:text-yellow-400 text-sm mb-4">
                Para comenzar a usar el módulo de contabilidad, necesitas
                inicializar el catálogo de cuentas basado en el Código Agrupador
                SAT (Anexo 24). Esto creará la estructura base de cuentas
                contables.
              </p>
              {showInitConfirm ? (
      ...
      <div className="mt-8 bg-primary-50 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 rounded-lg p-6">
        ...
        <p className="text-primary-700 dark:text-primary-400 text-sm">
          Este módulo está basado en el Código Agrupador de Cuentas del SAT
          (Anexo 24), cumpliendo con los requerimientos de la contabilidad
          electrónica en México. Soporta partida doble, períodos contables y los
