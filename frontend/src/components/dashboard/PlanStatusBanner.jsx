...
function PlanStatusBanner() {
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className={`flex items-center gap-1.5 ${appInfo?.color || 'text-gray-600'}`}>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {appsNoDisponibles.map(({ key, nombre, icon: AppIcon, color, bg }) => (
                <div
                  key={key}
                  className="flex items-center gap-1.5 px-2 py-1 rounded bg-gray-200 text-gray-500"
                >
  ...
  if (esPlanPro) {
    return (
      <div className="bg-gradient-to-r from-primary-50 to-purple-50 border border-primary-200 rounded-lg p-3 mb-6">
        <div className="flex items-center gap-3">
          <div className="bg-primary-600 text-white rounded-full p-1.5">
            <Crown className="w-4 h-4" />
          </div>
          <div>
            <span className="text-sm font-medium text-primary-900">Plan Pro</span>
