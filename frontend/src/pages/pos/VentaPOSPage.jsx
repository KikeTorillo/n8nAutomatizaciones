...
import { useSesionCajaActiva, useCategoriasPOS, useProductosPOS, useRegistrarPagosSplit } from '@/hooks/pos';
import { useEstadoCredito } from '@/hooks/personas';
import { useEvaluarPromociones } from '@/hooks/pos';
import { usePOSDisplaySync } from '@/hooks/pos';
import { usePOSCart } from '@/hooks/pos';
import { useModalManager } from '@/hooks/utils';
import POSHeader from '@/pages/pos/components/POSHeader';
import POSProductsSection from '@/pages/pos/components/POSProductsSection';
import POSNavTabs from '@/pages/pos/components/POSNavTabs';
import CarritoVenta from '@/pages/pos/components/CarritoVenta';
import PuntosCliente from '@/pages/pos/components/PuntosCliente';
import MetodoPagoModal from '@/pages/pos/components/MetodoPagoModal';
import SeleccionarNSModal from '@/pages/pos/components/SeleccionarNSModal';
import AperturaCajaModal from '@/pages/pos/components/AperturaCajaModal';
import CierreCajaModal from '@/pages/pos/components/CierreCajaModal';
import MovimientosCajaDrawer from '@/pages/pos/components/MovimientosCajaDrawer';
import ModificadoresProductoModal from '@/pages/pos/components/ModificadoresProductoModal';
import TipoVentaSelector from '@/pages/pos/components/TipoVentaSelector';
