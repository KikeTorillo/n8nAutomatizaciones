    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {!fecha && (
            <p className="text-sm text-gray-500 dark:text-gray-400 py-4 text-center bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          {fecha && isLoading && (
            <div className="flex items-center justify-center py-8 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              <Loader2 className="w-6 h-6 animate-spin text-primary-600 dark:text-primary-400 mr-2" />
              <span className="text-gray-600 dark:text-gray-400">Consultando disponibilidad...</span>
            </div>
          )}
          ...
          {fecha && error && (
            <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm font-medium text-red-800 dark:text-red-300">Error al consultar disponibilidad</p>
          ...
          {fecha && !isLoading && !error && slotsDisponibles.length === 0 && (
            <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm font-medium text-yellow-800 dark:text-yellow-300">No hay horarios disponibles</p>
          ...
          {fecha && !isLoading && !error && slotsDisponibles.length > 0 && (
            <div className="space-y-2">
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2 max-h-60 overflow-y-auto p-2 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${hora === slot.hora
                        ...
                        : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-600 hover:border-primary-400 dark:hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/30'
                      }
                    `}
                  >
                    {slot.hora}
