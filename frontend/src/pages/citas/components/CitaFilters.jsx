  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
        ...
        <div
          className={
            tieneMultiplesSucursales ? 'md:col-span-2' : 'md:col-span-3'
          }
        >
          ...
          <div className="md:col-span-2">
            ...
            >
              <Select
                ...
                onChange={(e) =>
                  handleInputChange('sucursal_id', e.target.value)
                }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <FormGroup label="Profesional">
              <Select
                ...
                onChange={(e) =>
                  handleInputChange('profesional_id', e.target.value)
                }
            ...
            <FormGroup label="Servicio">
              <Select
                ...
                onChange={(e) =>
                  handleInputChange('servicio_id', e.target.value)
                }
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                ...
                {filtros.estado && (
                  <span className="inline-flex items-center px-2 py-1 bg-white dark:bg-gray-800 rounded text-xs text-primary-800 dark:text-primary-300 border border-primary-300 dark:border-primary-700">
                    Estado:{' '}
                    {
                      estadosDisponibles.find((e) => e.value === filtros.estado)
                        ?.label
                    }
                    <button
                ...
                {filtros.servicio_id && (
                  <span className="inline-flex items-center px-2 py-1 bg-white dark:bg-gray-800 rounded text-xs text-primary-800 dark:text-primary-300 border border-primary-300 dark:border-primary-700">
                    Servicio:{' '}
                    {
                      serviciosOpciones.find(
                        (s) => s.value === filtros.servicio_id
                      )?.label
                    }
                    <button
                ...
                {filtros.sucursal_id && (
                  <span className="inline-flex items-center px-2 py-1 bg-white dark:bg-gray-800 rounded text-xs text-primary-800 dark:text-primary-300 border border-primary-300 dark:border-primary-700">
                    ...
                    Sucursal:{' '}
                    {
                      sucursalesOpciones.find(
                        (s) => s.value === filtros.sucursal_id
                      )?.label
                    }
                    <button
