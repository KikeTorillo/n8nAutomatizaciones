...
function SolicitudVacacionesModal({
  ...
  return (
    <Drawer isOpen={isOpen} onClose={handleClose} title="Solicitar Vacaciones">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        {/* Alerta de saldo */}
        {saldoInsuficiente && diasCalculados > 0 && (
          <Alert variant="danger" icon={AlertCircle} title="Saldo insuficiente">
            Estás solicitando {diasCalculados} días pero solo tienes{' '}
          ...
          {esMedioDia && (
            <div className="ml-6">
              ...
              {errors.turno_medio_dia && (
                <p className="mt-1 text-sm text-red-500">
                  {errors.turno_medio_dia.message}
                </p>
              )}
            </div>
          )}
        ...
        {diasCalculados > 0 && (
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4">
            <div className="flex items-center justify-between">
              ...
              <span
                className={`text-lg font-semibold ${saldoInsuficiente ? 'text-red-600' : 'text-primary-600 dark:text-primary-400'}`}
              >
            ...
            <div className="flex items-center justify-between mt-1">
              ...
              <span
                className={`text-sm ${saldoInsuficiente ? 'text-red-500' : 'text-gray-600 dark:text-gray-400'}`}
              >
        ...
        <div>
          ...
          {errors.motivo_solicitud && (
            <p className="mt-1 text-sm text-red-500">
              {errors.motivo_solicitud.message}
            </p>
          )}
        </div>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1">
          ...
          Las solicitudes deben hacerse con al menos {
