...
import BuscadorProductosPOS from '@/pages/pos/components/BuscadorProductosPOS';
import CategoriasPOS from '@/pages/pos/components/CategoriasPOS';
import ProductosGridPOS from '@/pages/pos/components/ProductosGridPOS';
