...
function MetricasGrid({ organizacion }) {
  const metricas = [
    ...
    {
      label: 'Citas mes',
      value: organizacion.citas_mes || organizacion.uso_citas_mes_actual || 0,
    },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-500 dark:text-gray-400">
            Plan:{' '}
            {organizacion.nombre_plan || organizacion.plan_actual || 'Sin plan'}
          </span>
        </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
          ...
          <div className="space-y-1">
            ...
            />
            <InfoItem icon={Building2} label="RFC" value={organizacion.rfc} />
            <InfoItem
              icon={Calendar}
              label="Fecha de registro"
              value={formatFecha(
                organizacion.creado_en || organizacion.created_at
              )}
            />
          </div>
        </div>
