...
function ProfesionalesServicioModal({ isOpen, onClose, servicio }) {
  ...
  const { data: profesionalesAsignados = [], isLoading: loadingAsignados } =
  ...
  const {
    ...
    queryFn: async () => {
      const response =
        await serviciosApi.obtenerProfesionalesConOrden(servicioId);
  ...
  return (
    <Drawer
      ...
      subtitle={
        servicio ? servicio.nombre : 'Selecciona los profesionales del servicio'
      }
    >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <p className="text-sm text-gray-700 dark:text-gray-300 font-medium">
                    {selectedProfessionals.length} de{' '}
                    {todosProfesionales.length} profesionales seleccionados
                  </p>
                        ...
                        {loadingOrden ? (
                          ...
                          <>
                            ...
                            <div className="flex items-start gap-2 text-xs text-primary-700 dark:text-primary-300 bg-primary-50 dark:bg-primary-900/30 p-2.5 rounded-lg">
                              ...
                              <span>
                                Este orden se usa cuando el cliente no
                                selecciona profesional y Round-Robin está
                                activo.
                              </span>
                            </div>
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-4">
                            Guarda primero los profesionales asignados para
                            poder ordenarlos.
                          </p>
                        )}
                      </div>
