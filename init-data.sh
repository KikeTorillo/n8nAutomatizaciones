...
echo ""
echo "    🎯 MÓDULO: Servicios (antes negocio - refactorizado Dic 2025)"
...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" -f "$SQL_DIR/catalogos/09-ubicaciones-trabajo.sql"
