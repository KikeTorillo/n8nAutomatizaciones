...
-- ====================================================================
-- FUNCIÓN 3: ACTUALIZAR TIMESTAMP TIPOS_PROFESIONAL
-- ====================================================================
...
COMMENT ON FUNCTION actualizar_timestamp_tipos_profesional() IS
'Actualiza automáticamente actualizado_en cuando se modifica un tipo de profesional';

-- ====================================================================
-- FUNCIÓN 4: PROTEGER TIPOS DEL SISTEMA (TIPOS_PROFESIONAL)
-- ====================================================================
...
COMMENT ON FUNCTION proteger_tipos_profesional_sistema() IS
'Protege tipos del sistema en tipos_profesional. Previene: eliminación, desactivación, cambio de código, asignación a organización';
