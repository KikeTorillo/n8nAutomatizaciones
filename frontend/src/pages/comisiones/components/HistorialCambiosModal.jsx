...
import { useHistorialConfiguracion } from '@/hooks/otros';
                      ...
                      <div>
                        <div
                          className={`h-10 w-10 rounded-full flex items-center justify-center ring-8 ring-white dark:ring-gray-800 ${
                            cambio.accion === 'INSERT'
                              ? 'bg-green-500'
                              : cambio.accion === 'UPDATE'
                                ? 'bg-primary-500'
                                : 'bg-red-500'
                          }`}
                        >
                      ...
                      <div className="min-w-0 flex-1">
                        <div>
                          <div className="flex items-center justify-between">
                            <span
                              className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${obtenerAccionColor(
                                cambio.accion
                              )}`}
                            >
                          ...
                          {cambio.accion !== 'DELETE' && (
                            <div className="mt-3 bg-gray-50 dark:bg-gray-700 rounded-lg p-3 border border-gray-200 dark:border-gray-600">
                              <div className="grid grid-cols-1 gap-3">
                                {/* Tipo de comisión */}
                                {cambio.tipo_comision_anterior !==
                                  cambio.tipo_comision_nuevo && (
                                ...
                                {/* Valor de comisión */}
                                {cambio.valor_comision_anterior !==
                                  cambio.valor_comision_nuevo && (
                                  <div className="flex items-center text-sm">
                                    <span className="text-gray-500 dark:text-gray-400 w-24">
                                      Valor:
                                    </span>
