 ...
 * />
 */
export const DirectorioFiltros = memo(function DirectorioFiltros({
  filtros,
  onChange,
  onLimpiar,
  className,
  ...
  const handleCiudadChange = useCallback(
    (e) => onChange('ciudad', e.target.value),
    [onChange]
  );
  const handleCategoriaChange = useCallback(
    (e) => onChange('categoria_id', e.target.value),
    [onChange]
  );
  const handleRatingChange = useCallback(
    (e) => onChange('rating_min', e.target.value),
    [onChange]
  );
          ...
          <div>
            ...
            {filtros.rating_min && (
              <div className="mt-2 flex items-center">
                <EstrellaRating
                  rating={parseInt(filtros.rating_min)}
                  size="sm"
                />
