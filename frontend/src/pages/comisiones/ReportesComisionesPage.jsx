        ...
        >
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-gray-500">Código Cita</p>
                <p className="font-medium text-gray-900 font-mono">{comisionSeleccionada.codigo_cita}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Fecha Cita</p>
                <p className="font-medium text-gray-900">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900">{comisionSeleccionada.estado_pago}</p>
              </div>
            </div>
            ...
            {comisionSeleccionada.detalle_servicios && (
              <div className="pt-4 border-t border-gray-200">
                <h4 className="font-medium text-gray-900 mb-3">Detalle de Servicios</h4>
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              <div className="flex justify-between items-center">
                <p className="text-lg font-medium text-gray-900">Comisión Total:</p>
              ...
              <div className="pt-4 border-t border-gray-200 bg-green-50 rounded-lg p-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  ...
                  {comisionSeleccionada.metodo_pago && (
                    <div>
                      <p className="text-green-700">Método:</p>
                      <p className="font-medium text-green-900">{comisionSeleccionada.metodo_pago}</p>
                    </div>
                  )}
                  {comisionSeleccionada.referencia_pago && (
                    <div className="col-span-2">
                      <p className="text-green-700">Referencia:</p>
