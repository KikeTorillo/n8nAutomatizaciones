        ...
        <div className="space-y-3">
              ...
              return (
                ...
                >
                  <input
                    ...
                    checked={isSelected}
                    onChange={(e) =>
                      handleChange('entidad_tipo', e.target.value)
                    }
                    disabled={!isNew}
                    className="sr-only"
                  />
          ...
          {!isNew && (
            <p className="text-xs text-amber-600 dark:text-amber-400 flex items-center gap-1">
              ...
              El tipo de entidad no se puede cambiar después de crear el
              workflow
            </p>
          )}
        </div>
          ...
          {showAdvanced && (
            <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  El workflow solo se ejecutará cuando la entidad cumpla esta
                  condición
                </p>
                <ConditionEditor
                  value={formData.condicion_activacion}
                  onChange={(value) =>
                    handleChange('condicion_activacion', value)
                  }
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3">
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange('prioridad', parseInt(e.target.value) || 0)
                    }
                    className="w-24"
                  />
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Si hay múltiples workflows para la misma entidad, se ejecuta
              ...
              <div className="flex items-start gap-2 p-3 bg-primary-50 dark:bg-primary-900/20 rounded-lg">
                ...
                <p className="text-xs text-primary-700 dark:text-primary-300">
                  La condición de activación y prioridad permiten tener
                  múltiples workflows para el mismo tipo de entidad con reglas
                  diferentes.
                </p>
              </div>
            </div>
