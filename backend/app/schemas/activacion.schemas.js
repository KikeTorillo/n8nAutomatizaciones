...
const activacionSchemas = {
    ...
    /**
     * POST /auth/registrar - Registro simplificado (sin password)
     * Crea organización + activación pendiente + envía email
     */
    registrar: Joi.object({
        body: Joi.object({
            ...
            // Plan y app (Modelo Free/Pro)
            plan: Joi.string()
                .valid('free', 'pro', 'trial')
                .default('trial')
                .messages({
                    'any.only': 'Plan debe ser free, pro o trial'
                }),
