 ...
 * Vista consolidada de metricas por sucursal con comparativas y tendencias
 */
        ...
        <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-6 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-red-700 dark:text-red-300 mt-1">
              {errorMetricas.message || 'Ocurrio un error al cargar los datos'}
            </p>
          </div>
        </div>
      )}
      ...
      {loadingMetricas ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
            No hay metricas para mostrar en este momento
          </p>
