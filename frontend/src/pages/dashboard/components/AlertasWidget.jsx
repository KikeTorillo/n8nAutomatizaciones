        ...
        <div className="space-y-3">
          {alertas.map((alerta) => {
            ...
            return (
              ...
              >
                <Icon
                  className={`h-5 w-5 mt-0.5 mr-3 flex-shrink-0 ${getNivelIcon(alerta.nivel)}`}
                />
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <span
                          className={`inline-flex px-2 py-0.5 text-xs font-semibold rounded-full ${getNivelColor(alerta.nivel)}`}
                        >
