...
const REFERENCIAS_SISTEMA = [
  {
    value: 'limite_aprobacion_usuario',
    label: 'Límite aprobación del usuario',
  },
  { value: 'limite_aprobacion_rol', label: 'Límite aprobación del rol' },
  {
    value: 'monto_maximo_sin_aprobacion',
    label: 'Monto máximo sin aprobación',
  },
    ...
    <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg space-y-4">
      ...
      <div>
        ...
        <Select
          ...
          options={[{ value: '', label: 'Selecciona un campo...' }, ...campos]}
        />
      </div>
      ...
      <div>
        ...
        <div className="flex gap-2">
          <button
            type="button"
            onClick={() =>
              onChange({ ...condicion, valor_tipo: 'fijo', valor_ref: null })
            }
            className={`
      ...
      {condicion.valor_tipo === 'referencia' && (
        <div>
          ...
          <Select
            ...
            onChange={(e) =>
              onChange({ ...condicion, valor_ref: e.target.value })
            }
            options={[
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400">
        Las condiciones determinan el flujo del workflow basándose en los datos
        de la entidad.
      </p>
    </div>
  );
