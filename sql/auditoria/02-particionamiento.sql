-- ====================================================================
-- 📅 MÓDULO AUDITORÍA - PARTICIONAMIENTO DINÁMICO
-- ====================================================================
--
-- Versión: 2.0.0
-- Fecha: Enero 2026
...
-- • Facilita archivado automático de datos antiguos
-- • Sin fechas hardcodeadas = sin obsolescencia
--
-- ====================================================================

-- ====================================================================
-- 📅 CREAR PARTICIONES DINÁMICAS DE EVENTOS_SISTEMA
-- ====================================================================
...
BEGIN
    ...
    RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
    RAISE NOTICE '📅 Particiones de eventos_sistema configuradas dinámicamente';
