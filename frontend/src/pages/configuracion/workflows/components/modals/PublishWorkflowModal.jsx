        ...
        {!isPublished && warningCount > 0 && validationErrors.length === 0 && (
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-3 mb-4 text-left">
            <p className="text-sm text-amber-700 dark:text-amber-300 flex items-center gap-2">
              ...
              {warningCount} advertencia{warningCount > 1 ? 's' : ''} (no
        ...
        {isPublished && instancesInProgress > 0 && (
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-3 mb-4 text-left">
            ...
            <p className="text-xs text-amber-600 dark:text-amber-400">
              Hay {instancesInProgress} instancia
              {instancesInProgress > 1 ? 's' : ''} en progreso. Continuarán
              ejecutándose pero no se crearán nuevas.
            </p>
          </div>
        )}
              ...
              <div className="space-y-2">
                ...
                <ul className="text-xs text-gray-500 dark:text-gray-400 space-y-1">
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    Comenzará a procesar{' '}
                    {workflow?.entidad_tipo?.replace('_', ' ')}
                  </li>
                </ul>
              </div>
            )}
