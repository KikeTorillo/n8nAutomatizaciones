...
export default function MetricCard({
  ...
  return (
    <div
      className={`${colors[color]} rounded-lg p-6 border-2 shadow-sm hover:shadow-md transition-shadow`}
    >
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          {trend !== undefined && trend !== null && (
            <div
              className={`text-xs mt-2 font-medium ${trend >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
            >
