                  ...
                  <tr key={index}>
                    <td className="px-2 py-2">
                      <select
                        value={mov.cuenta_id}
                        onChange={(e) =>
                          updateMovimiento(index, 'cuenta_id', e.target.value)
                        }
                    ...
                    <td className="px-2 py-2">
                      <input
                        ...
                        value={mov.concepto}
                        onChange={(e) =>
                          updateMovimiento(index, 'concepto', e.target.value)
                        }
                    ...
                    <td className="px-2 py-2">
                      <input
                        ...
                        value={mov.debe}
                        onChange={(e) =>
                          updateMovimiento(index, 'debe', e.target.value)
                        }
                        disabled={!!mov.haber}
                    ...
                    <td className="px-2 py-2">
                      <input
                        ...
                        value={mov.haber}
                        onChange={(e) =>
                          updateMovimiento(index, 'haber', e.target.value)
                        }
                        disabled={!!mov.debe}
                        className="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-sm text-right bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-1 focus:ring-primary-500 disabled:bg-gray-100 dark:disabled:bg-gray-700"
                      />
