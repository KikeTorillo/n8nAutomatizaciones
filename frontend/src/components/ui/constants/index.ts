 ...
 *
 * Uso:
 *   import { SEMANTIC_COLORS, BUTTON_SIZES } from '../constants';
 *   // o importar de archivo específico:
 *   import { SEMANTIC_COLORS } from '../constants/colors';
 *
 * Feb 2026 - Movido a components/ui/constants/
 * ====================================================================
 */
...
// Z-Index (Ene 2026)
export { Z_INDEX, Z_LAYER, Z_FIXED_POSITIONS } from './zIndex';

// Shadows (Ene 2026)
export { SHADOW, SHADOW_DARK, SHADOW_CONTEXT, ELEVATION } from './shadows';

// Border Radius (Ene 2026)
export { RADIUS, RADIUS_DIRECTIONAL, RADIUS_CONTEXT } from './radius';
...
export { THEME_FALLBACK_COLORS, getThemeFallback } from './themeDefaults';
