 ...
 * Centralizado desde components/inventario/producto-form/ - Ene 2026
 */
 ...
 */
export const productoDefaultValues = {
  nombre: '',
  descripcion: '',
  sku: '',
  codigo_barras: '',
 ...
 */
export const getProductoEditValues = (producto) => ({
...
export const defaultValuesCreate = productoDefaultValues;
export const getDefaultValuesEdit = getProductoEditValues;
