-- ====================================================================
-- 📅 MÓDULO CONTABILIDAD - PARTICIONAMIENTO DINÁMICO
-- ====================================================================
--
-- Versión: 2.0.0
-- Fecha: Enero 2026
...
-- ====================================================================
-- 📅 CREAR PARTICIONES DINÁMICAS DE ASIENTOS_CONTABLES
-- ====================================================================
...
BEGIN
    ...
    RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
    RAISE NOTICE '📅 Particiones de asientos_contables configuradas dinámicamente';
