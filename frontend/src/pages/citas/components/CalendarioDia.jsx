...
function CalendarioDia({
  ...
  if (compactMode) {
    ...
    return (
      <button
        onClick={() =>
          esDelMesActual && onDiaClick && onDiaClick(fechaISO, citas)
        }
            ...
            {citasVisibles.map((cita) => {
              ...
              return (
                <div
                  ...
                  onDragStart={(e) =>
                    esDraggable && handleCitaDragStart(e, cita)
                  }
                  className={`
                ...
                >
                  <button
                    ...
                    `}
                    style={{
                      borderLeftColor: obtenerColorFondo(cita.estado)
                        .replace('bg-', '')
                        .replace('-500', ''),
                    }}
