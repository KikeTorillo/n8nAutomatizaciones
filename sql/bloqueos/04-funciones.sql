...
-- ====================================================================
-- FUNCIÓN 5: ACTUALIZAR MÉTRICAS DE BLOQUEOS
-- ====================================================================
-- Actualiza el timestamp de última actualización en metricas_uso_organizacion
-- Se ejecuta después de INSERT/UPDATE/DELETE en bloqueos_horarios
-- ────────────────────────────────────────────────────────────────────
...
COMMENT ON FUNCTION actualizar_metricas_bloqueos() IS
'Trigger function: Actualiza métricas de uso después de INSERT/UPDATE/DELETE en bloqueos_horarios. Se ejecuta AFTER INSERT/UPDATE/DELETE.';
...
--
-- Por tipo:
-- • 3 Trigger functions (timestamps, validación, métricas)
...
-- • actualizar_metricas_bloqueos(): AFTER INSERT/UPDATE/DELETE
...
-- • metricas_uso_organizacion (tracking de cambios)
-- ====================================================================
