...
--
-- PROPÓSITO:
-- Triggers que automatizan validaciones y actualizaciones de timestamps
-- en bloqueos de horarios.
--
-- COMPONENTES:
...
-- ACTUALIZADO: 3 Febrero 2026 - Eliminado trigger de métricas no usado
-- ====================================================================
...
--
-- Por operación:
-- • INSERT: 1 trigger (validación)
-- • UPDATE: 2 triggers (validación, timestamp)
-- • DELETE: ninguno
--
