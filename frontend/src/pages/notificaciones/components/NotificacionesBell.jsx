  ...
  return (
    ...
    >
      <div className="flex gap-3">
        {/* Icono */}
        <div
          className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${nivelConfig.bg}`}
        >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <p
              className={`text-sm font-medium ${!notif.leida ? 'text-gray-900 dark:text-gray-100' : 'text-gray-600 dark:text-gray-400'}`}
            >
              {notif.titulo}
            </p>
