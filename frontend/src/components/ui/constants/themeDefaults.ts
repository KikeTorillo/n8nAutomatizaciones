 ...
 */
export const getThemeFallback = (
  module: keyof typeof THEME_FALLBACK_COLORS,
  key: string
) =>
  THEME_FALLBACK_COLORS[module]?.[
    key as keyof (typeof THEME_FALLBACK_COLORS)[typeof module]
  ] ??
  THEME_FALLBACK_COLORS.common?.[
    key as keyof typeof THEME_FALLBACK_COLORS.common
  ] ??
  THEME_FALLBACK_COLORS.website?.[
    key as keyof typeof THEME_FALLBACK_COLORS.website
  ];
