 ...
 */
export const ICONOS_MAP: Record<string, LucideIcon> = {
  // Productos y comercio
  Package,
  ShoppingCart,
  ShoppingBag,
...
export type IconoNombre = keyof typeof ICONOS_MAP;

/**
 * Categoría de iconos
 */
export interface CategoriaIconos {
  nombre: string;
  iconos: string[];
}
 ...
 */
export const CATEGORIAS_ICONOS: CategoriaIconos[] = [
  {
    nombre: 'Comercio',
    iconos: [
      'Package',
