 ...
 * ====================================================================
 *
 * Feed de notificaciones, preferencias, plantillas (admin).
...
interface NotificacionListParams {
...
interface NotificacionPreferencia {
  tipo: string;
  in_app: boolean;
  email: boolean;
  push?: boolean;
...
interface ActualizarPreferenciasData {
  preferencias: NotificacionPreferencia[];
}

interface NotificacionPlantilla {
  id: number;
