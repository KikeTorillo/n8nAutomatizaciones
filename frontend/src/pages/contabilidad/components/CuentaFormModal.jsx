...
export default function CuentaFormModal({
  ...
  useEffect(() => {
    if (cuenta?.id) {
      ...
      // Nueva subcuenta
      setFormData({
        codigo: cuenta.cuenta_padre?.codigo
          ? `${cuenta.cuenta_padre.codigo}.`
          : '',
        nombre: '',
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, codigo_sat: e.target.value })
            }
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Select
            ...
            onChange={(e) =>
              setFormData({ ...formData, naturaleza: e.target.value })
            }
        ...
        <div className="flex gap-6">
          <Checkbox
            ...
            onChange={(e) =>
              setFormData({ ...formData, afectable: e.target.checked })
            }
          />
          <Checkbox
            label="Activa"
