...
import EntitlementsFormDrawer from '@/pages/superadmin/components/EntitlementsFormDrawer';
...
function EntitlementsPlataforma() {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 'sm',
      render: (row) => (
        <Button size="sm" variant="outline" onClick={() => handleEditar(row)}>
          Editar
        </Button>
      ),
    },
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <DataTable
          ...
          emptyState={{
            ...
            title: 'No hay planes',
            description:
              'Crea planes en Suscripciones para configurar sus entitlements',
          }}
        />
      </div>
