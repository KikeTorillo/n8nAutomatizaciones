...
const EventoPreview = memo(function EventoPreview({ tipoEvento, datos, plantilla }) {
  const TIPO_LABELS = { boda: 'Boda', xv_anos: 'XV Años', bautizo: 'Bautizo', cumpleanos: 'Cumpleaños' };
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-gray-900 dark:text-white">
                {new Date(datos.fecha_evento + 'T12:00:00').toLocaleDateString('es-MX', {
        ...
        {datos.hora_evento && (
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-gray-900 dark:text-white">{datos.hora_evento}</p>
            </div>
          </div>
        )}
