...
const estadoConfig = {
  borrador: {
    ...
    icon: Clock,
    label: 'Borrador',
    description: 'La transferencia está en preparación',
  },
  enviado: {
    ...
    icon: Send,
    label: 'Enviado',
    description: 'El stock fue restado del origen, pendiente de recepción',
  },
  recibido: {
...
/**
 * Página de detalle de transferencia de stock
...
function TransferenciaDetailPage() {
  ...
  // Handler: Abrir modal de recepción
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-5xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-4">
              <BackButton to="/sucursales/transferencias" />
              <div>
        ...
        <div className="p-4">
          ...
          {itemsRecepcion.some((i) => i.cantidad_recibida !== i.cantidad_enviada) && (
            <div className="mt-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg flex items-start gap-2">
              ...
              <div className="text-sm text-yellow-700 dark:text-yellow-300">
                ...
                <p>Las cantidades recibidas no coinciden con las enviadas. Esto quedará registrado.</p>
              </div>
            </div>
          )}
          ...
          <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <Button
              ...
              disabled={recibirMutation.isPending}
            >
              {recibirMutation.isPending ? 'Procesando...' : 'Confirmar Recepción'}
            </Button>
          </div>
        </div>
      </Modal>
      ...
      >
        <div className="p-4">
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            ¿Estás seguro de cancelar la transferencia <strong>{transferencia.codigo}</strong>?
          </p>
          ...
          {transferencia.estado === 'enviado' && (
            <div className="mb-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg flex items-start gap-2">
              <AlertTriangle className="w-5 h-5 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-0.5" />
              <div className="text-sm text-yellow-700 dark:text-yellow-300">
                <p className="font-medium">El stock será devuelto</p>
                <p>Al cancelar, el stock será devuelto a la sucursal de origen.</p>
              </div>
            </div>
          )}
