...
function CitaDetailModal({
  ...
  const precioTotal =
    (cita.precio_total || cita.precio_servicio || 0) - (cita.descuento || 0);
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center gap-2">
                  <div
                    ...
                    style={{
                      backgroundColor: cita.profesional_color || '#6366f1',
                    }}
                  >
                  ...
                  >
                    ...
                    {servicio.descuento > 0 && (
                      <div className="mt-2 text-xs text-green-600 dark:text-green-400">
                        Descuento: -$
                        {parseFloat(servicio.descuento).toLocaleString('es-CO')}
                      </div>
                    )}
                    {servicio.notas && (
