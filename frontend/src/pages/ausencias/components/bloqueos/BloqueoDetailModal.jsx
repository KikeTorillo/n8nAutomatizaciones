...
function BloqueoDetailModal({
  ...
  const diasBloqueo = calcularDiasBloqueo(
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between pb-4 border-b border-gray-200">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              <div
                className={`w-12 h-12 ${colores.badge} rounded-lg flex items-center justify-center`}
              >
          ...
          <div className="flex flex-col items-end gap-2">
            <span
              className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${colores.bg} ${colores.text}`}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Alcance */}
          <div
            className={`rounded-lg p-4 ${esOrganizacional ? 'bg-red-50 border border-red-200' : 'bg-primary-50 border border-primary-200'}`}
          >
            <div className="flex items-center mb-3">
              {esOrganizacional ? (
            ...
            {esOrganizacional ? (
              <div className="space-y-2">
                ...
                <p className="text-xs text-red-700">
                  Este bloqueo afecta a <strong>toda la organización</strong> y
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p>
                  ...
                  <strong>{bloqueo.citas_afectadas} citas</strong>. Si modificas
                  o eliminas este bloqueo, puede tener impacto en estas
                  reservas.
                </p>
              </div>
            </div>
