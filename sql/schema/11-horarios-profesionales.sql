-- ====================================================================
-- ⚠️  ARCHIVO LEGACY - MIGRADO A ARQUITECTURA MODULAR
-- ====================================================================
--
-- Este archivo ha sido COMPLETAMENTE MIGRADO al módulo agendamiento.
--
-- 📁 NUEVA UBICACIÓN:
-- • sql/agendamiento/01-tablas-agendamiento.sql    (Tabla horarios_profesionales)
-- • sql/agendamiento/02-indices.sql                (5 índices)
-- • sql/agendamiento/03-rls-policies.sql           (Políticas RLS)
-- • sql/agendamiento/04-funciones.sql              (2 funciones)
-- • sql/agendamiento/05-triggers.sql               (2 triggers)
-- • sql/agendamiento/README.md                     (Documentación completa)
--
-- 🔄 MIGRACIÓN: 16 Noviembre 2025
-- ✅ ESTADO: Completamente migrado y probado
--
-- ⚠️  IMPORTANTE: Este archivo se mantiene solo por compatibilidad temporal.
-- ⚠️  TODO el código funcional está comentado abajo.
-- ====================================================================

-- ⚠️  MIGRADO A agendamiento/01-tablas-agendamiento.sql
-- -- ====================================================================
