 ...
 */
export default function ConteoFormModal({
  isOpen,
  onClose,
  onSubmit,
  isLoading,
  ...
  const handleSubmit = (e) => {
    ...
    const data = {
      ...
      usuario_contador_id: formData.usuario_contador_id
        ? parseInt(formData.usuario_contador_id)
        : undefined,
      usuario_supervisor_id: formData.usuario_supervisor_id
        ? parseInt(formData.usuario_supervisor_id)
        : undefined,
  ...
  const tipoDescripciones = {
    [TIPOS_CONTEO.TOTAL]:
      'Conteo de todos los productos activos de la organización.',
    [TIPOS_CONTEO.POR_CATEGORIA]:
      'Conteo de productos de una categoría específica.',
    [TIPOS_CONTEO.POR_UBICACION]:
      'Conteo de productos en una ubicación de almacén.',
    [TIPOS_CONTEO.CICLICO]: 'Conteo de productos seleccionados manualmente.',
    [TIPOS_CONTEO.ALEATORIO]:
      'Muestra aleatoria de productos para verificación.',
  };
      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-6">
        ...
        {formData.tipo_conteo === TIPOS_CONTEO.POR_UBICACION && (
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleFiltroChange('ubicacion_id', e.target.value)
              }
              required
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            >
        ...
        {formData.tipo_conteo === TIPOS_CONTEO.ALEATORIO && (
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleFiltroChange('cantidad_muestra', e.target.value)
              }
              min="10"
              max="500"
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              handleFiltroChange('solo_con_stock', e.target.checked)
            }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleChange('usuario_contador_id', e.target.value)
              }
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleChange('usuario_supervisor_id', e.target.value)
              }
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            >
              <option value="">Sin asignar</option>
