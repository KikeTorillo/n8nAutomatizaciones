...
--
-- Contenido:
-- - rol_usuario ENUM (6 niveles de acceso)
-- - industria_tipo ENUM (11 sectores empresariales)
-- - plan_tipo ENUM (4 planes de subscripción)
-- - estado_subscripcion ENUM (5 estados de suscripción)
-- - estado_cita ENUM (6 estados de citas)
-- - estado_franja ENUM (4 estados de disponibilidad)
-- - tipo_profesional ENUM (33 tipos especializados)
-- - plataforma_chatbot ENUM (7 plataformas de mensajería)
-- ====================================================================
