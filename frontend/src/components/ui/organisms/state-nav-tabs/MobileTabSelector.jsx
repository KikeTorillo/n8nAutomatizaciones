 ...
 * @param {Array} [props.mobileGroups] - Array de grupos para móvil (opcional)
                ...
                <div key={group.id}>
                  ...
                  {group.items?.map((item) => {
                    ...
                    return (
                      ...
                      >
                        {ItemIcon && (
                          <ItemIcon className={cn('h-4 w-4', isActive ? 'text-primary-600 dark:text-primary-400' : 'text-gray-400')} />
                        )}
