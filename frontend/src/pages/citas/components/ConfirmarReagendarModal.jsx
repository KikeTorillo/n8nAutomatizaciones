...
function ConfirmarReagendarModal({
  ...
  const tieneSolapamiento = advertencias.some(
    (adv) => adv.tipo === 'solapamiento'
  );
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Confirmar Reagendar Cita"
      size="large"
    >
      <div className="space-y-6">
        ...
        {!tieneSolapamiento && (
          <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <p className="text-sm text-green-900 dark:text-green-200">
              ✓ <strong>Sin conflictos:</strong> La cita se puede reagendar sin
              problemas
            </p>
          </div>
        )}
        ...
        {tieneSolapamiento && (
          <p className="text-xs text-red-600 dark:text-red-400 text-center">
            No se puede reagendar la cita porque hay un conflicto de horarios.
