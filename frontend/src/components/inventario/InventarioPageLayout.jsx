 ...
 * Reduce ~50 líneas de código repetitivo por página.
 *
 * @param {Object} props
 ...
 * @param {string} [props.subtitle] - Subtítulo o contador (ej: "15 productos en total")
 ...
 */
export default function InventarioPageLayout({
  icon: Icon,
  title,
  subtitle,
  actions,
