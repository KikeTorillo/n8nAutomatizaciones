...
import { Users, Tag, TrendingUp, ChevronDown, Check } from 'lucide-react';
import { cn } from '@/lib/utils';

/**
 * Definicion de items de navegacion para Clientes
 */
const NAV_ITEMS = [
...
function getActiveItem(pathname) {
  ...
  // Default a lista si estamos en /clientes/*
...
/**
 * Selector movil - Un unico dropdown con todos los items
 */
...
/**
 * ClientesNavTabs - Navegacion principal del modulo Clientes
 * Desktop: Tabs horizontales simples
 * Mobile: Dropdown selector unico
 */
