...
import {
  ...
  AsientoFormModal,
  AsientoDetailModal,
} from '@/pages/contabilidad/components';
...
function AsientosContablesPage() {
  ...
  const handlePublicar = async (asiento) => {
    try {
      await publicarAsiento.mutateAsync({
        id: asiento.id,
        fecha: asiento.fecha,
      });
    } catch {
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
              {busqueda
                ...
                : 'Crea tu primer asiento contable'}
            </p>
          </div>
        )}

        {/* Paginacion */}
        {asientosData?.paginacion &&
          asientosData.paginacion.total_paginas > 1 && (
          ...
          <div className="flex items-start gap-3 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg">
            ...
            <div>
              ...
              <p className="text-yellow-700 dark:text-yellow-400 text-sm mt-1">
                Un asiento anulado no se puede revertir. Se mantendra en el
                historial pero no afectara los saldos contables.
              </p>
            </div>
          </div>
