        ...
        <div className="space-y-3">
          <div className="bg-orange-50 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
            <p className="text-sm text-orange-900 dark:text-orange-200">
              ⚠️ <strong>Importante:</strong> Al marcar como No Show, la cita se
              registrará como finalizada por inasistencia del cliente. Esta
          ...
          <div className="bg-primary-50 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 rounded-lg p-4">
            <p className="text-sm text-primary-900 dark:text-primary-200">
              💡 <strong>Consejo:</strong> Considera contactar al cliente antes
              de marcar No Show para confirmar si tuvo algún inconveniente.
            </p>
          </div>
        </div>
