...
export const BUTTON_VARIANTS: Record<ButtonVariant, string> = {
  ...
  outline:
    'border-2 border-primary-300 text-primary-700 hover:bg-primary-50 focus-visible:ring-primary-500 dark:border-primary-600 dark:text-primary-300 dark:hover:bg-primary-950',
  danger:
  ...
  warning:
    'bg-amber-600 text-white hover:bg-amber-700 focus-visible:ring-amber-500 dark:bg-amber-700 dark:hover:bg-amber-600',
  success:
...
export const ICON_BUTTON_VARIANTS: Record<
  'ghost' | 'outline' | 'solid' | 'danger',
  string
> = {
  ghost:
    'text-gray-600 hover:bg-gray-100 focus-visible:ring-gray-500 dark:text-gray-400 dark:hover:bg-gray-800',
  outline:
    'border border-gray-300 text-gray-700 hover:bg-gray-50 focus-visible:ring-gray-500 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800',
  solid:
    'bg-primary-700 text-white hover:bg-primary-800 focus-visible:ring-primary-500 dark:bg-primary-600 dark:hover:bg-primary-500',
  danger:
    'text-red-600 hover:bg-red-50 focus-visible:ring-red-500 dark:text-red-400 dark:hover:bg-red-950',
};
...
export const INPUT_VARIANTS = {
  default:
    'border-gray-300 dark:border-gray-600 focus-visible:border-primary-500 focus-visible:ring-primary-500 dark:bg-gray-800 dark:text-gray-100',
  error:
    'border-red-500 dark:border-red-500 focus-visible:border-red-500 focus-visible:ring-red-500 dark:bg-gray-800 dark:text-gray-100',
  success:
    'border-green-500 dark:border-green-500 focus-visible:border-green-500 focus-visible:ring-green-500 dark:bg-gray-800 dark:text-gray-100',
  disabled:
 ...
 * NOTA: Usar 'danger' como nombre canónico, 'error' es alias para retrocompatibilidad
 */
export const TOAST_EXTENDED_VARIANTS: Record<
  string,
  ToastExtendedVariantStyles
> = {
  success: {
...
export const TOAST_CONTAINER_STYLES =
  'border rounded-lg p-4 shadow-lg flex items-start gap-3 min-w-[320px] max-w-md animate-slide-in-right';
